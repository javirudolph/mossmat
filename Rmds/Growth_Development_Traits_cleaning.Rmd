...
```{r}
#Comparing among family variance for week 3 area for each sex
Among_Family_A_Fem_sex <- lmer(Week_3_area~  (1|Family) +  (1|Plate), data = female_trait, REML = FALSE, na.action = na.omit)

Among_Family_A_Male_sex <- lmer(Week_3_area~  (1|Family) +  (1|Plate), data = male_trait, REML = FALSE, na.action = na.omit)
...
#Days until Gam 
```{r}
#Is there an affact of Sex?  -6.327797
...
```{r}
#Are these traits sexually dimorphic for variances 30.73701
...
```{r}
#Does the among family variance differ? -6.191903
