...
```{r}
fem_chromo_Llength <- lm(female_master_less_2$Leaf_Length_Average~ famid + famid:ID + ID, data = female_master_less_2)
...
fem_chromo_Larea <- lm(female_master_less_2$Leaf_Average_Area~ famid + famid:ID + ID, data = female_master_less_2)
summary(fem_chromo_Larea)
plot(fem_chromo_Larea)

male_chromo_Larea <- lm(male_master_less_2$Leaf_Average_Area~ famid + famid:ID + ID, data = male_master_less_2)
