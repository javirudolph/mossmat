...
#Imputing missing data with nearest neighbor
clean_master <- as.data.frame(clean_master)
clean_master_2 <-knnImputation(clean_master, k=6, scale= T, meth = "weighAvg", distData = NULL)

write_csv(clean_master_2, "/Users/lesliekollar/Desktop/Moss_matrix/cleandata/clean_master_imputed.csv")
write_csv(clean_master, "/Users/lesliekollar/Desktop/Moss_matrix/cleandata/clean_master.csv")
...
saveRDS(clean_master, "~/Desktop/Moss_matrix/cleandata/clean_master_matrix_imputed.RDS") #clean master not log transformed and not scaled
saveRDS(clean_master_log, "~/Desktop/Moss_matrix/cleandata/clean_master_matrix_log_voc_imputed.RDS") #clean master log transformed but not scaled
```
